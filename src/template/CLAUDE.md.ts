export const CLAUDE_MD_TEMPLATE = `# LLM Wiki Invest

当前工作区是一个 LLM Wiki Invest vault。所有 wiki 相关操作都使用
\`llm-wiki-invest\` skill。主 skill 位于 \`.claude/skills/llm-wiki-invest.md\`；
完整 \`/ingest\` 流程位于 \`.claude/skills/invest-wiki-ingest/SKILL.md\`。
